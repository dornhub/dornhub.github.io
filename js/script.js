...
(function() {
    ...
    window.onload = function() {
        ...
        if (customColor) {
            updateCustomColorItem(customColor);
        }
    };
	...
	document.getElementById("back-to-top-logo").onclick = function() {
        ...
        function triggerEasterEgg() {
            ...
            // 显示中央消息
            easterEggMessage.textContent = '恭喜你发现了彩蛋。欢迎你，𣿅国人！';
    ...
    let customColorItem; // 用于存储自定义颜色菜单项

    function createCustomColorItem(color) {
    ...
    function updateCustomColorItem(color) {
        if (customColorItem) {
            customColorItem.value = color;
            customColorItem.style.color = color;
            customColorItem.textContent = color; // 或者显示 '自定义颜色'
        } else {
            customColorItem = createCustomColorItem(color);
            document.getElementById('colorMenu').insertBefore(customColorItem, document.getElementById('customColorTrigger'));
        }
    }
...
    switch (weatherText) {
      case 'sunny': return '晴';
      case 'cloud': return '多云';
      case 'thunderstorm': return '雷暴';
      case 'partly_cloudy_day': return '多云';
      case 'severe_cold': return '严寒';
      case 'snowing': return '下雪';
      case 'foggy': return '有雾';
      case 'heat': return '炎热';
      case 'weather_hail': return '冰雹';
      case 'mist': return '薄雾';
      case 'snowing_heavy': return '大雪';
      case 'rainy_snow': return '雨夹雪';
      case 'rainy_light': return '小雨';
      case 'rainy_heavy': return '大雨';
      case 'rainy': return '雨';
      case 'snowing_light': return '小雪';
      default: return '未知';
    }
  }
